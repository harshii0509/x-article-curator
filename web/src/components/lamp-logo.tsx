 ...
 * Lamp SVG logo.
 *
 * All paths use `fill="currentColor"` — the colour is fully controlled by
 * the parent's CSS `color` property (or a Tailwind `text-*` class).
 *
 * Examples:
 *   Landing page  → wrap in <div className="text-ns-accent">
 *   Dark UI       → wrap in <div className="text-[#F4C96B]">
 */
